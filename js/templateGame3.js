...
const templateGame3 = getElementFromTemplate(`
  <header class="header">
...
const gameOptions = templateGame3.querySelectorAll(`.game__option`);
const backButton = templateGame3.querySelector(`.header__back`);
